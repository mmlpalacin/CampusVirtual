            ...
            @if ($tipo != 'Tutor')
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="{{ strtolower($tipo) }}[vive]" id="{{ strtolower($tipo) }}[vive]" data-tipo="{{ strtolower($tipo) }}">
            ...
            <section class="form-content-{{ strtolower($tipo) }}" style="display: none;">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="provincia-{{ strtolower($tipo) }}" name="{{ strtolower($tipo) }}[provincia_id]" data-tipo="{{ strtolower($tipo) }}" {{ old(strtolower($tipo) . 'provincia_id', $currentAdulto->provincia_id?? '') ? '' : 'disabled' }}>
                            <option value="">Seleccione un país</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="partido-{{ strtolower($tipo) }}" name="{{ strtolower($tipo) }}[partido_id]" data-tipo="{{ strtolower($tipo) }}" {{ old(strtolower($tipo) . 'partido_id', $currentAdulto->partido_id?? '') ? '' : 'disabled' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select id="ciudad-{{ strtolower($tipo) }}" name="{{ strtolower($tipo) }}[ciudad_id]" {{ old(strtolower($tipo) . 'ciudad_id', $currentAdulto->ciudad_id?? '') ? '' : 'disabled' }}>
