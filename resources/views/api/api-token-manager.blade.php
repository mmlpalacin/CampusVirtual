<div>
    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input id="name" type="text" class="mt-1 block w-full" wire:model="createApiTokenForm.name" autofocus for="name"/>
    ...
    <x-confirmation-modal wire:model.live="confirmingApiTokenDeletion">
        ...
        <x-slot name="footer">
            ...
            <button class="ms-3 btn btn-danger" wire:click="deleteApiToken" wire:loading.attr="disabled">
                {{ __('Delete') }}
            </button>
        </x-slot>
